...
public class BTBase
{
    ...
    public BTBase(SelectorNode hitNode, SelectorNode getAwayNode, SelectorNode idleNode)    // 초식
    {
    ...
    public BTBase(SelectorNode hitNode, SequenceNode trackingNode, SelectorNode idleActionNode)   // 육식
    {
        rootNode = new SelectorNode();
        this.hitNode = hitNode;
