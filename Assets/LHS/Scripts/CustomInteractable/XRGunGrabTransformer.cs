...
public class XRGunGrabTransformer : XRBaseGrabTransformer
{
    /// <summary>
    ...
    XRGunGrabInteractable gunGrabInteractable;
    ...
    {
        gunGrabInteractable = GetComponent<XRGunGrabInteractable>();
    ...
    public override void OnGrabCountChanged(XRGrabInteractable grabInteractable, Pose targetPose, Vector3 localScale)
    {
        ...
        {
            var interactor0 = gunGrabInteractable.interactors[0];
            var interactor1 = gunGrabInteractable.interactors[1];
    ...
    Vector3 ComputeNewScale(in XRGrabInteractable grabInteractable, in Vector3 startScale, in Vector3 currentScale, in Vector3 startHandleBar, in Vector3 newHandleBar, bool trackScale)
    {
        ...
        if (trackScale && interactorsCount == 1 && m_AllowOneHandedScaling && m_HasScaleValueProvider && m_ScaleValueProvider.scaleMode == UnityEngine.XR.Interaction.Toolkit.ScaleMode.Input)
        {
