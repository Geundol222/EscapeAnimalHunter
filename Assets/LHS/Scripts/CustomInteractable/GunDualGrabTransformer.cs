...
public class GunDualGrabTransformer : XRBaseGrabTransformer
{
    ...
    {
        IXRInteractor interactor = mainInteractor;
        ...
        Pose thisTransformPose = new Pose(grabInteractable.transform.position, grabInteractable.transform.rotation);
    ...
    {
        IXRInteractor interactor = subInteractor;
        Transform interactorAttachTransform = interactor.GetAttachTransform(grabInteractable);
        Pose interactorAttachPose = new Pose(interactorAttachTransform.position, interactorAttachTransform.rotation);
        //Transform thisAttachTransform = grabInteractable.GetAttachTransform(interactor);
        Transform thisAttachTransform = grabInteractable.secondaryAttachTransform;
        Pose thisTransformPose = new Pose(thisAttachTransform.position, thisAttachTransform.rotation);
